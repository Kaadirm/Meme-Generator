...
const wisBtn = document.getElementById("wis-btn");
const ridBtn = document.getElementById("rid-btn");
const revBtn = document.getElementById("rev-btn");

memeBtn.addEventListener("click", function showMeme() {
...
funBtn.addEventListener("click", function showJoke() {
...
wisBtn.addEventListener("click", function showQuote() {
...
ridBtn.addEventListener("click", function showRiddle() {
...
revBtn.addEventListener("click", function revealAnswers() {
